...
def producer(
    ...
    def __produce_message(conf: dict, topic, key, message, on_delivery, headers):
    ...
    delivery_info = __produce_message(conf, topic, key, message, on_delivery, headers)
